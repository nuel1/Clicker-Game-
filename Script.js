...
function KilledWorkers() {
    ...
    setTimeout(KilledWorkers2, 1500);
    KillAllWorkers();
}
...
function WorkerCountFunction() {
    ...
    document.getElementById("WorkerCount1").innerHTML = +WorkerSam + +WorkerRick + +WorkerMax + +WorkerSam_2 + +WorkerSam_3;
    WorkerCount1 = +WorkerSam + +WorkerRick + +WorkerMax + +WorkerSam_2 + +WorkerSam_3;
}
